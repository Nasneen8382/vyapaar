...
def saleorderto_invoice(request,id):
  ...
  return render(request, 'company/saleorderto_invoice.html',{'staff':staff,'Party':Party,'item':item,'bank':bank,'allmodules':allmodules,'sale':sale,'next_count':next_count,'par':par})
